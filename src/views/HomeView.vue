...
import { getPublicKey, loginIn } from '../api/login' 
...
const onFinish = async() => {
  ...
  let res1 = encrypt.encrypt(JSON.stringify({...formState}))
  let loginStatus = await loginIn({res1: res1})
